...
class LightRoom(avango.script.Script):
  ...
  def my_constructor(self,NAME,SCENEGRAPH,POSITION, EXITS, ACTIV, COLOR):
    ...
    self.lightcube.my_constructor(self.NAME, self.SCENEGRAPH, room_transform, ACTIV, EXITS)
    ...
    create_line_visualization2(loader, room_transform, right_upper_cornor, right_bottom_cornor, self.COLOR, 0.01)
    create_line_visualization2(loader, room_transform, right_bottom_cornor, left_bottom_cornor, self.COLOR, 0.01)
    create_line_visualization2(loader, room_transform, left_bottom_cornor, left_upper_cornor, self.COLOR, 0.01)
    create_line_visualization2(loader, room_transform, left_upper_cornor, right_upper_cornor, self.COLOR, 0.01)

    create_line_visualization2(loader, room_transform, top_right_upper_cornor, top_right_bottom_cornor, self.COLOR, 0.01)
    create_line_visualization2(loader, room_transform, top_right_bottom_cornor, top_left_bottom_cornor, self.COLOR, 0.01)
    create_line_visualization2(loader, room_transform, top_left_bottom_cornor, top_left_upper_cornor, self.COLOR, 0.01)
    create_line_visualization2(loader, room_transform, top_left_upper_cornor, top_right_upper_cornor, self.COLOR, 0.01)

    create_line_visualization2(loader, room_transform, right_upper_cornor, top_right_upper_cornor, self.COLOR, 0.01)
    create_line_visualization2(loader, room_transform, right_bottom_cornor, top_right_bottom_cornor, self.COLOR, 0.01)
