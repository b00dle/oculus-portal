...
class LightCube(avango.script.Script):
  ...
  def my_constructor(self, NAME,PARENT_NODE, SCENEGRAPH, ACTIV, LIGHTEXITS):
    # init light cube
    ...
    self.PARENT_NODE.Children.value.append(self.cube_transform)
    ...
    self.enable_console(self.PARENT_NODE)
