...
class OVRUser(User):
  ...
  def __init__(self, VIEWING_MANAGER, HEADTRACKING_TARGET_NAME, OVR_USER_ID, INITIAL_PLATFORM_ID, NO_TRACKING_MAT, SCENEGRAPH):
    ...
    self.create_avatar_representation(SCENEGRAPH, INITIAL_PLATFORM_ID, self.tracking_rotation_combiner.get_sf_avatar_body_matrix(), self.left_hand_trackingreader.sf_abs_vec, self.right_hand_trackingreader.sf_abs_vec)
